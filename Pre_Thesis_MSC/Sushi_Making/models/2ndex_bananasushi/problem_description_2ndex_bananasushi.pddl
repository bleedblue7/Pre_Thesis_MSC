(define (problem 2ndex_bananasushi) 
 ...
 (:init 
 	...
 	(=(serve-saliency) 1) 
 	(=(roll-saliency) 1) 
 	(=(cut-saliency edges bread) 1) 
 	(=(spread-saliency nutella bread) 1) 
 	(=(spread-saliency butter bread) 1) 
 	(=(sprinkle-saliency sugar slice) 1) 
 	(=(place-saliency banana length) 1) 
 	(=(cover-saliency roll honey) 1) 
 	(=(cover-saliency roll syrup) 1) 
 	(=(ends-saliency banana) 1) 
 	(property-off bread) 
 	(property-over bread) 
 	(property-over slice) 
